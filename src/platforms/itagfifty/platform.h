 ...
 * Copyright (C) 2021 Björn Kalkbrenner <terminar@cyberphoria.org>
 *
...
#define PLATFORM_IDENT        " (itag.fifty))"

/*
JTag header:
  ----------------------------
  | VCC/VTREF    | VCC (opt) |
0 | TRST         | GND       | GPIOC5   (Test Reset optional)
1 | NC/TDI       | GND       | GPIOB10
2 | SWDIO/TMS    | GND       | GPIOB1   (SWDIO)
3 - SWDCLK/TCLK  | GND       | GPIOB0   (SWCLK)
4 - RTCK         | GND       | GPIOB12
5 | SWO/TDO      | GND       | GPIOC7   (input for TRACESWO)
6 | RESET        | GND       | GPIOC4   (nRST /RESET / System Reset)
7 | NC           | GND       |
  | NC           | GND       |
  ----------------------------
 ...
 *
 * LED0 = 	PC6	(Green LED : Running)
 * LED0 = 	PC6	(Green LED : Idle)
 * LED0 = 	PC6	(Green LED : Error)
 * LED0 = 	PC6	(Green LED : Bootloader active)
 *
 * USB VBUS detect:  PA9
 *
  J2-0 = VDD
